"""backup test_backup_makeconfigbackup module"""
import os
import shutil
...
def test_make_config_backup_nonverbose_pass(capsys,mocker) -> None:
    """backup test_make_config_backup_nonverbose_pass function"""
...
def test_make_config_backup_verbose_pass_valid(capsys,mocker) -> None:
    """backup test_make_config_backup_verbose_pass_valid function"""
    test_backup_dir = VALID_CWD + "/backup-" + VALID_MOCK_TIMESTAMP
     #patch timestamp
    mocker.patch("src.backup.generate_timestamp", return_value=VALID_MOCK_TIMESTAMP)
    #patch list backups to 0 so dont get warning about 5 or more backups
...
def test_make_config_backup_verbose_pass_testfilesystem(tmp_path, monkeypatch, capsys) -> None:
    """backup test_make_config_backup_verbose_pass_testfilesystem function"""
...
def test_make_config_backup_nonverbose_pass_testfilesystem(tmp_path, monkeypatch, capsys) -> None:
    """backup test_make_config_backup_nonverbose_pass_testfilesystem function"""
...
def test_make_config_backup_nonverbose_pass_warn_backup_count(monkeypatch, tmp_path, capsys) -> None:
    """backup test_make_config_backup_nonverbose_pass_warn_backup_count function"""
...
def test_make_config_backup_pass_creates_sample_and_copies_all(tmp_path, monkeypatch) -> None:
    """backup test_make_config_backup_pass_creates_sample_and_copies_all function"""
...
def test_make_config_backup_fail_patched_runtimeerror_exception(capsys) -> None:
    """backup test_make_config_backup_fail_patched_runtimeerror_exception function"""
...
def test_make_config_backup_fail_patched_generic_exception(capsys) -> None:
    """backup test_make_config_backup_fail_patched_generic_exception function"""
...
def test_generate_timestamp() -> None:
    """backup test_generate_timestamp function"""
