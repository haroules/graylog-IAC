"""
test_graylog_verify_main module
"""
...
VALID_SCRIPT = "graylog_verify.py"
...
def test_graylog_verify_main():
    """Function test_graylog_verify_main"""
...
def test_graylog_verify_main_success(
    ...
    """Function test_graylog_verify_main_success"""
    ...
    mock_check_args_verify.return_value = ["graylog_clean.py"]
    graylog_verify.main()
    mock_check_args_verify.assert_called_once()
    mock_set_global_vars_verify.assert_called_once()

@mock.patch('graylog_verify.check_args_verify')
def test_graylog_verify_main_invalid_args(mock_check_args_verify):
    """Function test_graylog_verify_main_invalid_arg"""
