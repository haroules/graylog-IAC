"""clean test_get_list_all_builtin_index_set_ids module"""
import json
...
def test_get_list_all_builtin_index_set_ids_pass(mocker ) -> None:
    """clean test_get_list_all_builtin_index_set_ids_pass function"""
    mock_response = Mock()
...
def test_get_list_all_builtin_index_set_ids_non_200_response_fail(mocker) -> None:
    """clean test_get_list_all_builtin_index_set_ids_non_200_response_fail"""
    mock_response = Mock()
