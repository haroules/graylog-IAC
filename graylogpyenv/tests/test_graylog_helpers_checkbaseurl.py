...
def test_check_graylog_baseurl_pass_mocked_valid_response(capsys,requests_mock):
...
def test_check_graylog_baseurl_fail_mocked_invalid_response(requests_mock):
    args = [VALID_SCRIPT, VALID_TOKEN, VALID_TEST_URL_NONEXIST, VALID_CWD]
...
def test_check_graylog_baseurl_fail_valid_endpoint_bad_url(requests_mock):
    args = [VALID_SCRIPT, VALID_TOKEN, VALID_TEST_URL_NONEXIST, VALID_CWD]
...
def test_check_graylog_baseurl_fail_validtesturlnonexist():
    args = [VALID_SCRIPT, VALID_TOKEN, VALID_TEST_URL_NONEXIST, VALID_CWD]
...
def test_check_graylog_baseurl_fail_malformed_url():
